...
The progress of the homelab is documented in a **storytelling format** through my [blog]([https://kincodes.com](https://kincodes.com/posts/kinhos-homelab-series-securing-my-network-with-tailscale/), where I share updates, challenges, and lessons learned during the development and expansion of the cluster.
